...
const CarDetails = ({isOpen, closeModal, car}: CarCardProps) => {
  return (
    <>
            ...
            <Transition.Child
                ...
                leaveTo="opacity-0 scale-95">
                    ...
                    <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto
                     transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-5'>
                   ...
                   <div className="flex-1 flex flex-col gap-2">
                    ...
                    <div className="mt-3 flex flex-wrap">
                        {Object.entries(car).map(([key, value]) => (
                            <div className="flex justify-between gap-5 w-full text-right p-2" key={key}>
                                <h4 className="text-gray capitalize font-semibold">
                                    {key.split('_').join(' ')}
                                </h4>
